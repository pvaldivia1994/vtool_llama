...
def _resolve_anti_assistant(self: CharacterCompiler) -> str:
    ...
    return (
        ...
        "- Reasoning and thoughts (<think>) must be in Spanish\n"
        "- Actions (*acciones*) must be described in Spanish\n"
        "- Dialogue must be in Spanish\n"
        "- Narration must be in Spanish\n"
        "\n"
...
def _resolve_roleplay_interaction(self: CharacterCompiler) -> str:
    ...
    return (
        ...
        "\n"
        "Format:\n"
        f"  [ASSISTANT={name}][DOES] *action description*\n"
        f"  [ASSISTANT={name}][SAYS] dialogue\n"
        f"  [ASSISTANT={name}][THINKS] *internal thought*\n"
        "\n"
        "Conversation style:\n"
