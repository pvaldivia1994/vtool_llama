# Orquestador — vtool_llama

Sistema de inyección de contexto conversacional dinámico. Permite agregar entradas de contexto persistentes que se inyectan automáticamente en el prompt del personaje.
